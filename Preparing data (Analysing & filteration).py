...
with open('/Users/Shubham/Documents/Project Stock predictions/data/djia_data.csv', 'rt') as csvfile:
                ...
                if any(substring in NYTimes_data["response"]["docs"][i]['type_of_material'].lower() for substring in
                    ...
                    if any(substring in NYTimes_data["response"]["docs"][i]['section_name'].lower() for substring in
                        ...
                        articles_dict = {your_key: NYTimes_data["response"]["docs"][i][your_key] for your_key in
                                         dict_keys}
                        articles_dict['headline'] = articles_dict['headline'][
                            'main']  # Selecting just 'main' from headline
...
interpolated_df.to_pickle(
    '/Users/Shubham/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')

# Save pandas frame in csv form
interpolated_df.to_csv(
    '/Users/Shubham/Documents/Project Stock predictions/data/sample_interpolated_df_10_years_filtered_lead_para.csv',
    sep='\t', encoding='utf-8')

# Reading the data as pickle file
dataframe_read = pd.read_pickle(
    '/Users/Shubham/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')
